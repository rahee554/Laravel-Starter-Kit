...
<body>
<div class="auth-layout-premium-dark">
    <div class="premium-background"></div>
    <div class="auth-container">
        <div class="auth-card auth-card-dark">
            <!-- Logo & Branding Section -->
            <div class="auth-header auth-header-dark">
                <div class="logo-placeholder logo-dark">L</div>
            ...
            @hasSection('footer-links')
                <div class="auth-links auth-links-dark">
                    @yield('footer-links')
                </div>
            @endif
        </div>
